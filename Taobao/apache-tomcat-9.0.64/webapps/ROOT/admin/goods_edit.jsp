...
<div class="container-fluid">
	...
	<form class="form-horizontal" action="/admin/goods_edit" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="image2" value="${g.image }"/>
		...
		<div class="form-group">
			...
			<div class="col-sm-6"><img src="${pageContext.request.contextPath }${g.image }" width="100" height="100"/>
				<input type="file" name="image"  id="input_file">推荐尺寸: 500 * 500
			</div>
		</div>
